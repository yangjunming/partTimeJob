...
<!-- 														<h3>General</h3> -->
					...
					success : function(data) {
						...
						if (data.length > 0) {
							...
							for (var i = 0; i < data.length; i++) {
								...
								tr += "<td>" + status + "</td>";
								tr += "<td><a class='remove btn btn-primary input-xs' href=javascript:commentDetailed("+data[i].commentId+")>详情</a></td>";
								tr += "</tr>";
							}
		...
		function commentDetailed(id){
			var infoId = $("#infoId").val();
			window.location.href="<%=basePath%>views/enterprise/comment-info.jsp?id="+id+"&infoId="+infoId+"";
		}
		</script>
</body>
</html>
